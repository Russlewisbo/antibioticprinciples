...
-   More lipophilic antibiotics diffuse out of plasma into tissue; they favour distribution to lipid-rich tissues

-   If the drug has a net negative charge, it can still leave capillaries through endothelial fenestratations but further tissue penetration depends on:
...
By 5-6 half-lives most of a drug will be eliminated without repeat dosing.
...
![](images/tkcurve2.png){fig-align="center" width="600"} <br> ::: aside [@craig_1998a]
...
## Pharmacodynamic parameters predictive in animals and humans {.smaller}
...
-   Bacterial inoculum is retained in dialysis cartridge.
...
## In vitro hollow-fibre models {.smaller}
