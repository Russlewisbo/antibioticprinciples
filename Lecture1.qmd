...
<br> <br> <br> <br> <br> ![](unipd.png){.absolute top="550" left="950" width="100" height="100"}
...
-   Review key pharmacokinetic (PK) characteristics of antibiotics
-   Describe major pharmacodynamic (PD) patterns of antibiotics
    -   How can PD be determined pre-clinically?
-   Apply PK/PD information to individualise patient antibiotic therapy
-   Explore approaches to combination antibiotic therapy
...
-   **Small intestine:** Transit time 4-6 h; 6-7m long x 2.5cm internal diameter
...
![](images/absorption.png){fig-align="center" width="800"}
...
::: aside
Image source: www.biorender.com
:::
...
::::: columns
::: {.column width="20%"}
![](images/stickynote.jpeg.jpg){width="600"}
:::
...
-   Facilitated by solute carrier transporters (SLCs), which are present in the GI tract, liver & kidney
...
## The new rule of antibiotics:

<br> <br> <br>

<center>***Oral is the new IV!***</center>

## Bioavailability examples-1 {.smaller}
...
======= +-------------------------+-------------------------+-------------------------+ \| \| Tetracycline \| \>90 \| +-------------------------+-------------------------+-------------------------+ \| \| Doxycycline \| 80-90 \| +-------------------------+-------------------------+-------------------------+ \| \| Chloramphenicol \| 85 \| +-------------------------+-------------------------+-------------------------+ \| \| Erythromycin \| 20-25 \| +-------------------------+-------------------------+-------------------------+ \| \| Clarithromycin \| 55 \| +-------------------------+-------------------------+-------------------------+ \| \| Azithromycin \| 37 \| +-------------------------+-------------------------+-------------------------+ \| \| Clindamycin \| 90 \| +-------------------------+-------------------------+-------------------------+ \| \| Minocycline \| 95 \| +-------------------------+-------------------------+-------------------------+ \| \| Linezolid \| 100 \| +-------------------------+-------------------------+-------------------------+
:::

## Bioavailability examples-2 {.smaller}
...
-   **Amoxicillin:** Absorption is saturable near 750 mg
    ...
    -   Bioavailibility markedly decreases with higher doses- more GI side effects
    -   Dosing differs for common respiratory indications vs. bloodstream infections

-   **Cephalexin:** Maximum amount absorbed is \~4g/d

-   **Macrolides:** Bioavailability poor, but drugs concentrate intracellularly

-   **‘UTI drugs’:** Fosfomycin, trimethoprim, nitrofurantoin, pivmecillinam have relatively poor bioavailability:
...
## Recommendations for food co-administration {.smaller}

<br> <br>

| **Timing with food** | **Antibiotic** |
|----|----|
| “Empty stomach” <br>(1h before or 2h after meal) | Penicillin, <br> Flucloxacillin <br> Azithromycin <br> Fosfomycin |
...
-   Average plasma volume in adults is approximately 3.5L
...
::: {.column width="40%"}
<br> <br> ![](images/vd_breakdown.png){width="600"}
:::
:::::
...
e.g., fluoroquinolones, doxycycline, tigecycline do not achieve peak concentrations in bloodstream that surpass the MIC of many pathogens
...
-   [Only free drug distributes out of plasma and has pharmacological effect]{bg="yellow"}

## Factors affecting volume of distribution, cont.

<br><br>

-   **Tissue protein binding (e.g., muscle, fat)**

    -   This ‘drains’ the drug from plasma

    -   This reduces amount of plasma free drug

-   **Drug-specific tissue binding sites**

    -   e.g., bone (tetracyclines), adipose tissue (macrolides, fluoroquinolones), liver (rifampin, ceftriaxone), lung (fluoroquinolones, macrolides), kidneys (aminoglycosides, amphotericin B)
...
-   **More vascular tissue (e.g., heart, lung, kidney) have greater drug delivery versus skin, bone, fat**
...
![](images/sepsis_vd.png){fig-align="center" width="800"}
...
+-----------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------+---------+ \| **Factor** \| **Explanation** \| \| +-----------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------+---------+ \| **Age** \| Declines with age \| \| +-----------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------+---------+ \| **Sex** \| Males have larger livers —\> more rapid metabolism of drugs \| \| +-----------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------+---------+ \| **Genetics** \| CYP isoenzymes exhibit high rates of genetic polymorphism, which can affect the efficiency with which the individual can process the enzyme’s drug targets. \| \| +-----------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------+---------+ \| **Cardiac output** \| Less cardiac output —\> less drug delivered to the liver per minute —\> slower rate of metabolism \| \| +-----------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------+---------+ \| **Drug interactions** \| See next slide \| \| +-----------------------+-----------------------------------------------------------------------------------------------------------------------------------
...
-   **CYP enzyme inhibitors**
    ...
    -   How long will inhibition last once perpetrator is removed?
        ...
        -   Competitive inhibitor: Determined by the half life the perpetrator drug-i.e. should abate after 3-5 half lives
...
|-----------------|-------------------|--------------------|
| **Amoxicillin** | 1                 | every 8 hours      |
| **Doxycycline** | 12                | every 24 hours     |

<br>

<br>

More than 90% of drug will be eliminated *without* repeat dosing by 5-6 half-lives

## ***β***-lactam examples {.smaller}

<br>

| **Antimicrobial** | **Metabolism** | **Excretion** | **Vd (L); Bold** | **Clearance (ml/min)** | **Half life (h)** |
|----|----|----|----|----|----|
...
| **Nafcillin** | CYP3A4, undergoes enterohepatic recirculation. Induced CYP3A4 | Hepatic \<30 | 28 | N/A | 0.5 - 1 |
| **Flucloxacillin** | \< 30% hepatic metabolism, no effects on CYP3A4 | Hepatic: mostly | 13 |  | 0.75 - 1 |
| **Pivmecillinam** | Hydrolised to mecillinam. cleavage results in release of pivalic acid which is conjugated to carnitine in liver | 14 - 28 |  | 1.2 |  |
...
| **Target** | **Antimicrobial** | **Metabolism** | **Elimination** | **Vd (L)** | **Clearance (ml/min)** | **Half life (h)** |
|----|----|----|----|----|----|----|
...
-   Most common populations with augmented clearance:
    ...
    -   patients with severe burns, pregnancy, sepsis

-   **Combined with increased Vd, often leads to inadequate antibiotic exposures during sepsis**
:::
:::::
...
## How to define concentration-time-kill <br>effect curves? {.smaller}
...
![](images/fraction_interpret.png){width="1500"}
...
::: aside
A complete list of references supporting these targets are presented in the review by: [@Abdul-Aziz2015]. <br> T~\>MIC~ Time above MIC during dosing interval; C~max~/MIC- peak serum concentration to MIC ratio; AUC~0-24~/MIC- 24 hour Area under the curve to MIC ratio; *t*MSW-Time in mutant selection window
:::
...
## Types of pharmacokinetic analysis {.smaller}
...
## Monte Carlo Simulation {.smaller background-image="images/dice.png" background-opacity="0.2"}
...
<br> https://tdmx.shinyapps.io/Meropenem/
