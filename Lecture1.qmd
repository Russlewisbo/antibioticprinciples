...
## Lecture 1: General principles of antibiotic therapy {background-video="/images/bacteria.mp4" background-video-loop="true" background-video-muted="true"}
...
![](unipd.png){.absolute top="550" left="150" width="100" height="100"}
...
::: {.column width="50%"}
<br> <br> ![](images/bodycomp.png){width="183"}
:::
:::
...
-   Nomenclature:
    ...
    ![](images/cyp.png){fig-align="center" width="600"}
...
## Clearance: Key pharmacokinetic parameter
...
## Non beta-lactam antibiotics {.smaller}
...
-   Drug specific guidance for patient on dialysis

## Be careful about prematurely reducing <br> antibiotic doses based on serum creatinine

<br>

-   Antibiotic renal dose adjustments in drug labels are based on patients with [chronic kidney disease]{.underline}

-   Renal impairment is [acute, not chronic, in up to 50% of patients with infection]{.underline} and frequently [resolves within the first 48 hours]{.underline}
...
-   Renal dose reduction in the first 48 hours of therapy may unnecessarily result in underdosing of antibiotics
...
::: columns
::: {.column width="30%"}
![](images/kidney-1.svg){width="200"}
:::

::: {.column width="70%"}
<br> <br>

-   Common causes: “hyperdynamic state” with Gram-negative sepsis, vasoactive medications to support blood pressure large-volume fluid resuscitation

-   Most common populations with augmented clearance:

    -   Younger patients (i.e. trauma)

    -   Severe burn patients pregnant patients septic patients without renal dysfunction
...
## Laws of antimicrobial pharmacodynamics {background-image="images/pd.jpg" background-opacity="0.1"}
...
[@Abdul-Aziz2015]. <br> T~\>MIC~ Time above MIC during dosing interval; C~max~/MIC- peak serum co ncentraton to MIC ration; AUC~0-24~/MIC- 24 hour Areua under the curve to MIC ration; *t*MSW-Time in mutaant selection window
:::
...
## Laws of pharmacodynamics {background-image="images/pd.jpg" background-opacity="0.1"}
